...
const VAULT_CONTRACT_ABI = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_DailyGM", type: "address" },
    ...
    inputs: [
      {
        ...
        internalType: "struct DailyGMV2.CreateDropInputParams",
        name: "inputParams",
        type: "tuple",
      },
    ],
    ...
    inputs: [
      {
        ...
        internalType: "struct DailyGMV2.CreateEditionInputParams",
        name: "inputParams",
        type: "tuple",
      },
    ],
