...
contract LensFollowPlugin is BasePluginWithEventMetadata, FunctionsClient, ILogAutomation {
    ...
    function executeFromPlugin(
        ...
        string memory _followHandle=safeToVerifyParams[address(safe)].followHandle;
