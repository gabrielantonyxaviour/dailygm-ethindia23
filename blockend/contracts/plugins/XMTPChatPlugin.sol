...
contract XMTPChatPlugin is BasePluginWithEventMetadata,FunctionsClient,ILogAutomation {
    ...
    constructor(address _manager,bytes32 _donId,address _functionsRouter,address _crossChainRouter,address _link,string memory _sourceCode)
        BasePluginWithEventMetadata(
            PluginMetadata({name: "XMTP Chat Plugin", version: "1.0.0", requiresRootAccess: false, iconUrl: "", appUrl: ""})
        )
